...
> 📷 截图待补：图谱抽取确认弹窗。放图后替换为 `![图谱确认弹窗](../../../image/cn/guide/knowledge-base/graph-01.png)`
...
> 📷 截图待补：文档图谱页面（节点关系画布 + 加载更多）。放图后替换为 `![知识图谱](../../../image/cn/guide/knowledge-base/graph-02.png)`
...
- 停用片段会同时删除其图谱足迹；重新启用后如需图谱，需再次抽取（见[分段管理 · 片段启停](segment.md#片段启停)）；
