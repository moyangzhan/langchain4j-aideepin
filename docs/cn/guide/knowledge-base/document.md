...
<figure>
  <img src="../../../image/cn/guide/knowledge-base/document-01.png" alt="文档列表">
...
<figure>
  <img src="../../../image/cn/guide/knowledge-base/document-03.png" alt="索引弹窗">
...
| 已启用 | 开关。停用后该文档不参与检索（后果见[分段管理](segment.md#片段启停-各模式通用)） |
| 创建 / 更新时间 | 最近变更 |
