export default {
  ...
  knowledgeBase: {
    ...
    ingestSplitStrategy: 'Split Strategy',
    ingestMaxSegmentSize: 'Max Segment Size (Tokens)',
    ingestCustomSeparator: 'Custom Separator',
    ingestCustomSeparatorPlaceholder: 'Select or enter a custom separator',
    splitStrategyRecursive: 'Recursive',
    splitStrategyParagraph: 'By Paragraph',
    splitStrategyLine: 'By Line',
    splitStrategySentence: 'By Sentence',
    splitStrategyCustom: 'Custom Separator',
    separatorParagraph: '\\n\\n (Paragraph)',
    separatorLine: '\\n (Line break)',
  ...
  dashboard: {
    ...
    newKnowledgePoints: 'New Documents',
  ...
  columns: {
    ...
    sourceCharacterChat: 'Character Chat',
    sourceKnowledgeBaseQa: 'Knowledge Base QA',
    sourceKnowledgeBaseIngest: 'Knowledge Base Ingest',
    sourceWorkflowNode: 'Workflow Node',
    sourceAgent: 'Agent',
    sourceLongTermMemoryExtraction: 'Long-term Memory Extraction',
    sourceLongTermMemoryAnalysis: 'Long-term Memory Analysis',
  },
  route: {
    dashboard: 'Dashboard',
    console: 'Dashboard',
    ...
    tokenMonitorList: 'Token Monitor',
  },
  tokenMonitor: {
    userName: 'User',
    userNamePlaceholder: 'Enter user name',
    modelNamePlaceholder: 'Enter model name',
    modelPlatformPlaceholder: 'Enter model platform',
    sourceTypePlaceholder: 'Select source type',
  },
}
