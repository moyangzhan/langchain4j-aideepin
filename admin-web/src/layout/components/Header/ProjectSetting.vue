  ...
  <n-drawer v-model:show="isDrawer" :width="width" :placement="placement">
    <n-drawer-content :title="title" :native-scrollbar="false">
      <div class="drawer">
        ...
        <n-divider title-placement="center">{{ t('setting.systemTheme') }}</n-divider>
        ...
        <n-divider title-placement="center">{{ t('setting.navMode') }}</n-divider>
            ...
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  ...
                  :alt="t('setting.leftMenuMode')"
                />
              </template>
              <span>{{ t('setting.leftMenuMode') }}</span>
            </n-tooltip>
            ...
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  ...
                  :alt="t('setting.topMenuMode')"
                  @click="togNavMode('horizontal')"
                />
              </template>
              <span>{{ t('setting.topMenuMode') }}</span>
            </n-tooltip>
            ...
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  ...
                  :alt="t('setting.topMenuMixMode')"
                />
              </template>
              <span>{{ t('setting.topMenuMixMode') }}</span>
            </n-tooltip>
            <n-badge dot color="#19be6b" v-show="settingStore.navMode === 'horizontal-mix'" />
          </div>
        </div>

        <n-divider title-placement="center">{{ t('setting.navStyle') }}</n-divider>
          ...
          <div class="drawer-setting-item-style align-items-top">
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  src="~@/assets/images/nav-theme-dark.svg"
                  :alt="t('setting.darkSidebar')"
                  @click="togNavTheme('dark')"
                />
              </template>
              <span>{{ t('setting.darkSidebar') }}</span>
            </n-tooltip>
            ...
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  ...
                  :alt="t('setting.lightSidebar')"
                  @click="togNavTheme('light')"
                />
              </template>
              <span>{{ t('setting.lightSidebar') }}</span>
            </n-tooltip>
            ...
            <n-tooltip placement="top">
              <template #trigger>
                <img
                  ...
                  :alt="t('setting.darkHeader')"
                />
              </template>
              <span>{{ t('setting.darkHeader') }}</span>
            </n-tooltip>
            <n-badge dot color="#19be6b" v-if="settingStore.navTheme === 'header-dark'" />
          </div>
        </div>
        <n-divider title-placement="center">{{ t('setting.interfaceFunction') }}</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.splitMenu') }}</div>
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.fixedHeader') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.fixedTabs') }}</div>
          <div class="drawer-setting-item-action">
            <n-switch v-model:value="settingStore.multiTabsSetting.fixed" />
          </div>
        </div>

        <n-divider title-placement="center">{{ t('setting.interfaceDisplay') }}</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.showReloadButton') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.showBreadcrumb') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.showBreadcrumbIcon') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.showMultiTabs') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <n-divider title-placement="center">{{ t('setting.animation') }}</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.disableAnimation') }}</div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title">{{ t('setting.animationType') }}</div>
