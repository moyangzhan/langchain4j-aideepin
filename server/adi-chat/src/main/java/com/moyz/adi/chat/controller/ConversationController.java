 ...
 * 对话controller
 */
@Tag(name = "对话controller | Conversation Controller", description = "对话controller | Conversation Controller")
...
public class ConversationController {
    ...
    @Operation(summary = "获取当前用户所有的对话 | List All Conversations")
    @GetMapping("/list")
    ...
    @Operation(summary = "根据预设会话创建用户自己的会话 | Create Conversation from Preset")
