...
public class EpisodicMemoryService {
     ...
     * {@code sourceMsgId} produce duplicate rows, which is acceptable for
     ...
     * @param sourceMsgId source message id, stored in metadata for traceability only
    ...
    public void batchAdd(Long characterId, Long userId, Long sourceMsgId,
        ...
        for (ExtractedEpisodicEvent event : events) {
            ...
            // Build metadata with a mutable HashMap so sourceMsgId can be conditionally
