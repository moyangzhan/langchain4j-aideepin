...
5. 配置并启用模型平台（至少启用一个，可参考根目录 README 中的表格选择），或使用[管理端](../admin-web/README.zh-CN.md)在界面上配置
...
Docker 启动（仅后端服务，如需一键启动全部服务请使用 [docker/](../docker/README.zh-CN.md)）：
