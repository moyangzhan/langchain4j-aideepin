...
public class OllamaImageModel implements ImageModel {
    ...
    public Response<Image> edit(Image image, String prompt) {
        ...
        String imageUrl = imageUrl(image, modelName, "");
        ImageSynthesisParam.ImageSynthesisParamBuilder<?, ?> builder =
    ...
    public static class OllamaImageModelBuilder {
        ...
        public OllamaImageModelBuilder apiKey(String apiKey) {
            this.apiKey = apiKey;
            return this;
        }
        ...
        public OllamaImageModelBuilder size(String size) {
            this.size = size;
            return this;
        }

        public OllamaImageModelBuilder task(String task) {
            this.task = task;
            return this;
        }

        public OllamaImageModelBuilder function(String function) {
            this.function = function;
            return this;
        }

        public OllamaImageModelBuilder negativePrompt(String negativePrompt) {
            this.negativePrompt = negativePrompt;
            return this;
        }

        public OllamaImageModel build() {
            return new OllamaImageModel(baseUrl, apiKey, modelName, task, function, seed, size, negativePrompt);
        }
    }
