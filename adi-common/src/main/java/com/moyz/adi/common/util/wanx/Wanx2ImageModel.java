 ...
 */
@Slf4j
public class Wanx2ImageModel implements ImageModel {
    ...
    public static class WanxImageModelBuilder {
        ...
        public Wanx2ImageModel build() {
            return new Wanx2ImageModel(baseUrl, apiKey, modelName, seed, size, negativePrompt);
        }
    }
